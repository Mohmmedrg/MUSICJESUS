...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "⃟𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐨𝐛𝐫𝐚⃟", url="https://t.me/TTUT2"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("اوامر التشغيل", url=f"https://t.me/TTUT2"),
                InlineKeyboardButton(
                    "مطور السورس", url=f"https://t.me/IEBIE"
                ),
            ]
        ]
    )

    alive = f"**هلا {message.from_user.mention()}, i'm {BOT_NAME}**\n\nℹ️ البوت شغال 𖠀\nℹ️ مساعدي: [{ALIVE_NAME}] \n\n**وفف واخيرا ضفتوني ههسة اطربكم 🫂༗** 💖"
